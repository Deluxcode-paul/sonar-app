    ...
    <div>
        ...
        <body class="nav-night frontpage">
            ...
            <div class="container-m bg-white feature-quote">
                <landingQuote class="feature-quote-inner" bodyClass="quote-text line-height color-black" personClass="strong strip color-black" containerClass="width-l align-center center-block margin-s" body="We can now bill and invoice our customers automatically. We no longer need to collect credit card details anymore and no more writing and sending invoices every month. No more headaches from customers not paying, or chasing new payment info." person="GNathan Fillmore, Mile High Networks" :invertLogo="false" logo="milehigh.png" />
            </div>
